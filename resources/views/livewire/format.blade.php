<div>
    ...
    <input type="text"  class="w-full rounded border shadow p-2 mr-2 my-2 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150" placeholder="Heading/Title" wire:model.debounce.500ms="heading">
          
        <textarea type="text"  class="w-full rounded border shadow p-2 mr-2 my-2 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150" placeholder="Submit a Scam Format"
