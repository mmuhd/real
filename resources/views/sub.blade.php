            ...
            <div class="flex flex-col justify-around">
                <div class="space-y-6">
                    <h2 class="mt-6 text-3xl font-extrabold text-center text-gray-900 leading-9">
                        Submit Emails Suspected with Scam
                    </h2>
                    ...
                    <ul class="list-reset">
                        <li class="inline px-6">
                            <a href="/sub" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">Search Email</a>
                        </li>
                        <li class="inline px-6">
